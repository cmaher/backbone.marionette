  ...
  describe("filtering", function () {
    ...
    describe("testChild", function() {
      it("returns the result of the filter", function() {
        ...
        expect(collectionView.testChild(this.passModel)).to.be.true;
        expect(collectionView.testChild(this.failModel)).to.be.false;
      });
      ...
      it("will prefer to use the filter supplied at construction", function() {
        ...
        expect(collectionView.testChild(this.passModel)).to.be.false;
        expect(collectionView.testChild(this.failModel)).to.be.true;
      });

      it("always returns true when no filter is supplied", function (){
        var collectionView = new this.MockCollectionView();
        expect(collectionView.testChild(this.passModel)).to.be.true;
        expect(collectionView.testChild(this.failModel)).to.be.true;
      });
    });
      ...
      describe("when the view has been rendered and has not been destroyed", function () {
        ...
        describe("when the filter has changed", function () {
          ...
          it("should render", function() {
            expect(this.collectionView.render).to.have.been.called;
          });
